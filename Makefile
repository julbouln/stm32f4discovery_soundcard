...
SRCS      += stm32f4xx_hal_rcc.c stm32f4xx_hal_rcc_ex.c stm32f4xx_hal.c stm32f4xx_hal_cortex.c stm32f4xx_hal_gpio.c \
			 stm32f4xx_hal_pcd.c stm32f4xx_hal_pcd_ex.c stm32f4xx_hal_hcd.c stm32f4xx_hal_i2s.c stm32f4xx_hal_i2s_ex.c \
			 stm32f4xx_hal_dma.c stm32f4xx_hal_i2c.c stm32f4xx_ll_usb.c\
			 $(BSP_BASE).c stm32f4_discovery_audio.c cs43l22.c \
			 usbd_core.c usbd_ctlreq.c usbd_ioreq.c usbd_audio.c \
